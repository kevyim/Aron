...
# Run on your local machine with Grok CLI installed
...
grok --model grok-3 \
  ...
  -o output/stills/scene1_origin.png
...
grok --model grok-3 \
  ...
  -o output/stills/scene2_craft.png
...
grok --model grok-3 \
  ...
  -o output/stills/scene3_pearls.png
...
grok --model grok-3 \
  ...
  -o output/stills/scene4_hero.png

echo ""
echo "✅ All 4 hero stills generated in output/stills/"
